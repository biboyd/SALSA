...
O_p3_frac = [x[2]/x[7] for x in vals]
O_p4_frac = [x[3]/x[7] for x in vals]
O_p5_frac = [x[4]/x[7] for x in vals]
O_p6_frac = [x[5]/x[7] for x in vals]
O_p7_frac = [x[6]/x[7] for x in vals]
...
#line_3, = plt.plot(time, O_p3_frac, lw=2, label='O IV')
#line_4, =plt.plot(time, O_p4_frac, lw=2, label='O V')
#line_5, =plt.plot(time, O_p5_frac, lw=2, label='O VI')
#line_6, =plt.plot(time, O_p6_frac, lw=2, label='O VII')
#line_7, =plt.plot(time, O_p7_frac, lw=2, label='O VIII')
...
plt.savefig("tmb_isogal_%s_fractions.png" % element)
